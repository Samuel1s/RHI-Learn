...
// ABAP - Imports
import { syntaxLanguage } from "./abap/section-1.js"
import { poo } from "./abap/section-2.js"
import { verslag } from "./abap/section-3.js"
...
const allTemplates = [
    ...
    // About ABAP
    {
        template: syntaxLanguage.template
    },
    {
        template: poo.template
    },
    {
...
const scene = () => {
    progressbar.style.width = ((cont + 1) * (100/allTemplates.length)) + '%'
}
